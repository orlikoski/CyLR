...
echo ".\warp-packer.exe --arch $WARP_ARCH --input_dir $env:BUILD_DIR/CyLR/bin/release/netcoreapp2.1/$env:BUILD_ARCH/publish --exec CyLR.exe --output $env:BUILD_DIR/deployments/$env:BUILD_ARCH/CyLR.exe"
...
$Target = "$env:BUILD_DIR/archive/CyLR-$env:BUILD_ARCH.zip"

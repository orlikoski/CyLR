...
.\warp-packer.exe --arch $WARP_ARCH --input_dir $BUILD_DIR/CyLR/bin/release/netcoreapp3.1/$env:BUILD_ARCH/publish --exec CyLR.exe --output $BUILD_DIR/deployments/$env:BUILD_ARCH/CyLR.exe
